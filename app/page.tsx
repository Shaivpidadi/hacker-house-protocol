    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50">
        ...
        <div className="max-w-md mx-auto">
          ...
          <div className="flex items-center justify-center gap-8 mb-6">
            <div className="flex flex-col items-center">
              ...
              <span className="text-sm font-medium text-black border-b-2 border-blue-600 pb-1">Apartments</span>
            </div>
            <div className="flex flex-col items-center">
      ...
      <div className="max-w-md mx-auto px-4 pb-24">
        ...
        <div className="flex justify-between items-center mb-4">
          ...
          <Button variant="ghost" className="text-blue-500 font-medium hover:text-blue-600 transition-colors">
            View All
          </Button>
        </div>
              ...
              <CardContent className="p-4">
                <div className="flex gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="font-semibold text-base mb-1">{house.title}</h3>
                    <div className="flex items-center gap-1 mb-2">
                      <MapPin className="w-3 h-3 text-gray-400" />
                      <span className="text-sm text-gray-500">{house.location}</span>
                      <Users className="w-3 h-3 text-gray-400 ml-2" />
                      <span className="text-sm text-gray-500">{house.attendees} members</span>
                    </div>
        ...
        <div className="max-w-md mx-auto px-4 py-2">
          <div className="flex justify-around">
            ...
            <Button
              variant="ghost"
              className="flex flex-col items-center py-2 text-gray-500 hover:text-gray-700 transition-all duration-200 hover:scale-110"
              onClick={() => (user ? null : (window.location.href = "/welcome"))}
            >
