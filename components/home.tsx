...
import { Search, Menu, MapPin, Users, Heart, Info, Zap, Globe } from "lucide-react"
  ...
  const events = [
    {
      ...
      description: "Build the future of Web3 with the best developers worldwide.",
      attendees: 250,
      date: "Aug 15-17, 2025",
      type: "Hackathon",
      prize: "50 ETH",
    ...
    <div className="min-h-screen bg-background max-w-md mx-auto">
      ...
      <div className="px-4 py-4">
        ...
        <div className="flex items-center justify-center gap-8 mb-6">
          ...
          >
            <div
              className={`w-12 h-12 rounded-lg flex items-center justify-center mb-2 transition-all duration-300 ${
                activeTab === "Apartments" ? "gradient-primary shadow-lg glass" : "bg-muted glass-card"
              }`}
            >
              <div
                className={`w-6 h-6 rounded ${activeTab === "Apartments" ? "bg-primary-foreground" : "bg-primary"}`}
              ></div>
            </div>
            <span
              className={`text-sm font-medium transition-colors duration-300 ${
                activeTab === "Apartments" ? "text-primary border-b-2 border-primary pb-1" : "text-muted-foreground"
              }`}
            >
              Apartments
            </span>
          ...
          >
            <div
              className={`w-12 h-12 rounded-lg flex items-center justify-center mb-2 transition-all duration-300 ${
                activeTab === "Events" ? "gradient-primary shadow-lg glass" : "bg-muted glass-card"
              }`}
            >
              <Zap className={`w-6 h-6 ${activeTab === "Events" ? "text-primary-foreground" : "text-primary"}`} />
            </div>
            <span
              className={`text-sm font-medium transition-colors duration-300 ${
                activeTab === "Events" ? "text-primary border-b-2 border-primary pb-1" : "text-muted-foreground"
              }`}
            >
              Events
            </span>
      ...
      <div className="px-4 pb-24">
        <h1 className="text-2xl font-bold mb-6 gradient-primary bg-clip-text text-transparent">
          {activeTab === "Apartments" ? "Explore Hackathon Events!" : "Web3 Events & Hackathons"}
        </h1>
        ...
        {activeTab === "Events" ? (
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="text-right">
                          ...
                          <div className="font-bold text-chart-2">{event.prize}</div>
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <>
            ...
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-lg font-semibold text-foreground">Hacker Houses</h2>
              <Link href="/explore">
                <Button variant="ghost" className="text-primary font-medium hover:bg-muted transition-colors">
                  View All
                </Button>
              </Link>
            </div>
                ...
                >
                  <CardContent className="p-4">
                    <div className="flex gap-4">
                      ...
                      <div className="flex-1">
                        <h3 className="font-semibold text-base mb-1 text-foreground">{house.title}</h3>
                        <div className="flex items-center gap-1 mb-2">
                          ...
                          <span className="text-sm text-muted-foreground">{house.attendees} members</span>
                        </div>
                    ...
                    <div className="relative h-48 gradient-secondary">
                      ...
                      <div className="absolute bottom-4 left-4 text-primary-foreground">
                        ...
                        <div className="flex items-center gap-2 mb-3">
                          <span className="text-lg font-semibold">${property.price}/Day</span>
        ...
        <h2 className="text-lg font-semibold mb-4 text-foreground">Find Hacker Homies</h2>
